...
print(timedelta(weeks=20, days=365, hours=5, minutes=29))
...
print("today's date in one year:", str(now + timedelta(days=365)))
...
print("one week ago from now was:", s)
...
if afd < today:
    print("April fool day has already passed by: ", str((today - afd).days))
